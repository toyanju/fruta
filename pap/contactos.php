<html>
	<head>
		...
		<meta name="description" content="comer comida nepalesa e indiana em portugal">
		<title>Restaurante-Contatos</title>
		<!-- Font awesome CDN -->
	...
	<body>
				...
				<div class="container">
					<nav class="nav">
						...
						<ul class="lists">
							...
							<li class="nav-list">
								<a href="#" class="nav-link">Ementa</a>
							</li>
							<li class="nav-list">
		...
		<section class="midd">
			<div class="container">
				<h2 class="first-letter animate__animated animate__lightSpeedInLeft">C</span>ontatos</h2>
				<div class="emj animate__animated animate__lightSpeedInLeft">
					<div class="left">-----</div>
					<div class="moon">
